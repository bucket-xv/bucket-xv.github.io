...
<img src="_posts/images/hardware-efficient-ansatz.jpg" alt="Fig2" width="300"/>
...
<img src="_posts/images/zz.png" alt="zz" height="150"/>
...
| -------- | ------- |
| $e^{- i \frac{\theta}{2} \sigma_{z}^{(0)} \sigma_{z}^{(1)} \sigma_{z}^{(2)} \sigma_{z}^{(3)}}$ | <img src="_posts/images/zzzz.png" alt="Fig3" height="150"/>|
| $e^{- i \frac{\theta}{2} \sigma_{x}^{(0)} \sigma_{z}^{(1)} \sigma_{z}^{(2)} \sigma_{z}^{(3)}}$ | <img src="_posts/images/xzzz.png" alt="Fig3" height="150"/>    |
| $e^{- i \frac{\theta}{2} \sigma_{y}^{(0)} \sigma_{z}^{(1)} \sigma_{z}^{(2)} \sigma_{z}^{(3)}}$   | <img src="_posts/images/yzzz.png" alt="Fig3" height="150"/>    |
| $e^{- i \frac{\theta}{2} \sigma_{x}^{(0)} \sigma_{x}^{(1)} \sigma_{y}^{(2)} \sigma_{x}^{(3)}}$ |<img src="_posts/images/xxyx.png" alt="Fig3" height="150"/> |
